...
export default function UuidGeneratorTool() {
  ...
  // Gerado no efeito (após a montagem no navegador), não durante o render.
  // Evita divergência entre o HTML exportado estaticamente e o primeiro
  // render no cliente, já que crypto.randomUUID() muda a cada execução.
  useEffect(() => {
    generate(1);
  ...
  return (
    <ToolPanel>
      ...
      <div className="mt-4 rounded-xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark p-4 max-h-64 overflow-y-auto min-h-[3rem]">
        {uuids.map((id) => (
